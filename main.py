...
#df = pd.DataFrame([
#    dict(Task="Job A", Start='2025-10-07', Finish='2009-02-28', Resource="Nevin"),
#    dict(Task="Job A", Start='2009-01-01', Finish='2009-02-28', Resource="Nevin"),

#    dict(Task="Job B", Start='2009-03-05', Finish='2009-04-15', Resource="Femi"),
#    dict(Task="Job C", Start='2009-02-20', Finish='2009-05-30', Resource="")
#])
